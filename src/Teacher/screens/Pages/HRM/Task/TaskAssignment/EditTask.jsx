...
import { X, Pencil, ChevronDown, Eye, Trash2, Edit, Users, Calendar, Target, FileText } from "lucide-react";
...
export default function EditTask() {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      alert("Task updated successfully! (UI Demo)");
    }, 1500);
  };
  ...
  const handleEditEmployee = (employee) => {
    ...
    alert(`Editing ${employee.employeeName} - form fields populated`);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6 sm:mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Update task information and assignments</p>
            </div>
          </div>
          <button
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <div className="text-sm space-y-1">
                  ...
                  <div className="flex">
                    <span className="font-medium w-32">Assigned:</span>
                    <span className="text-gray-700">
                      {new Date(form.assignedDate).toLocaleDateString()} {new Date(form.assignedDate).toLocaleTimeString()}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="Enter specific responsibilities"
            />
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-semibold text-gray-900">Assigned Employees ({assignedEmployees.length})</h2>
                  ...
                  <tr>
                    <td colSpan="5" className="py-8 text-center">
                      <div className="text-gray-500">
                        ...
                        <p className="text-sm mt-1">Add employees using the form above</p>
                      </div>
                    </td>
                  </tr>
                ) : (
          ...
          <div className="lg:hidden space-y-4">
            {assignedEmployees.length === 0 ? (
              <div className="bg-gray-50 rounded-xl p-8 text-center border border-gray-200">
                ...
                <p className="font-medium text-gray-600">No employees assigned</p>
                <p className="text-sm text-gray-500 mt-1">Add employees using the form above</p>
              </div>
            ) : (
              currentEntries.map((employee) => (
        ...
        <div className="mt-6 p-6 bg-white rounded-2xl shadow-lg border border-gray-200">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h3 className="font-semibold text-gray-900">Ready to Update Task</h3>
              <p className="text-sm text-gray-600 mt-1">
                Task will be updated with {assignedEmployees.length} assigned employee(s)
              </p>
            </div>
            <button
              onClick={handleSubmit}
              disabled={isSubmitting}
              className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 min-w-[180px] justify-center"
            >
              {isSubmitting ? (
                <>
