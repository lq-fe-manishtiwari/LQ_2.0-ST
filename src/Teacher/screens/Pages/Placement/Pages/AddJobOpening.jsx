...
export default function AddJobOpening() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAlertConfig({
                success: true,
                title: 'Job Opening Added Successfully!',
            ...
            alert("Error adding job opening. Please try again.");
        }
    };
    ...
    return (
        <div className="p-6">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-semibold text-blue-700">Add Job Opening</h2>
                <button
                    type="button"
