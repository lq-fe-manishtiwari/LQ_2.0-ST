...
export default function AddDepartment() {
  ...
  // Dummy department data for edit mode
  const dummyDepartments = {
    1: { departmentName: "Computer Science", collegeName: "Engineering College" },
    2: { departmentName: "Mathematics", collegeName: "Science College" },
    3: { departmentName: "Physics", collegeName: "Science College" },
    4: { departmentName: "Business Administration", collegeName: "Business College" },
    5: { departmentName: "English Literature", collegeName: "Arts College" }
  };
  ...
  useEffect(() => {
    if (isEditMode && id) {
      ...
      // Simulate API call
      setTimeout(() => {
        const departmentData = dummyDepartments[id];
        if (departmentData) {
  ...
  // Custom classes from CreateTask.jsx
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.departmentName.trim() || !formData.collegeName) {
    ...
    setTimeout(() => {
      ...
      setAlertMessage(`Department ${isEditMode ? 'updated' : 'added'} successfully!`);
    ...
    return (
      <div className="w-full flex flex-col gap-8 p-4 sm:p-6 md:p-8">
        <div className="flex items-center justify-center py-12">
          ...
          <p className="text-gray-500 ml-4">Loading department data...</p>
        </div>
      </div>
    );
  }
