...
import { Calendar, X, Edit, ChevronDown } from "lucide-react";
    ...
    <div className="w-full flex flex-col gap-8 p-4 sm:p-6 md:p-8">
      ...
      <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border">
        ...
        <div className="flex justify-center gap-4 mt-8">
          <button 
            type="submit"
            className="px-8 py-3 rounded-lg shadow-md text-white bg-blue-600 hover:bg-blue-700 transition-all font-medium"
          >
            Update
          </button>
