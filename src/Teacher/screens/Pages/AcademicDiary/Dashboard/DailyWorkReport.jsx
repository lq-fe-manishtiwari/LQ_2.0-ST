                ...
                <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-3xl overflow-hidden animate-in zoom-in-95 duration-200">
                                    ...
                                    <div key={idx} className="space-y-5 border-b border-gray-100 last:border-0 pb-6 last:pb-0">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="p-5 bg-purple-50/50 rounded-2xl border border-purple-100">
                                                {detail.notes ? (
                                                    <p className="text-gray-700 leading-relaxed text-sm font-medium whitespace-pre-line">{detail.notes}</p>
                                                ) : (
                        ...
                        <div className="p-6 border-t border-gray-100 flex justify-end bg-gray-50/50">
                            <button onClick={() => { setShowLectureModal(false); setLectureDetails(null); }} className="px-8 py-3 bg-blue-600 text-white rounded-2xl font-bold text-sm hover:bg-blue-700 transition-all shadow-lg shadow-blue-100">Close</button>
                        </div>
                    </div>
                </div>
            )}
