        ...
        <table className="min-w-full border-collapse">
          <thead>
            <tr className="bg-blue-50 text-left text-gray-700 font-semibold">
              ...
              <th className="px-4 py-3 border-b">Form Name</th>
              <th className="px-4 py-3 border-b">Form URL</th>
          ...
          <tbody>
            {feedbackForms.map((form) => (
              ...
              >
                <td className="px-4 py-3 border-b">{form.sr}</td>
                <td className="px-4 py-3 border-b font-medium text-gray-800">
                  {form.formName}
                </td>
                <td className="px-4 py-3 border-b text-blue-600 underline cursor-pointer">
