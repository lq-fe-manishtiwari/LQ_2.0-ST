...
export const INITIAL_DEVELOPMENTAL_STATE = {
    ...
    poMapping: [],
    items: [
        { id: Date.now(), label: 'Project includes a title page.', required: true, bloomsLevel: [], coMapping: [], poMapping: [] },
        { id: Date.now() + 1, label: 'All sections are properly headed.', required: true, bloomsLevel: [], coMapping: [], poMapping: [] },
        { id: Date.now() + 2, label: 'Bibliography is formatted correctly.', required: true, bloomsLevel: [], coMapping: [], poMapping: [] }
    ]
};
