...
function getClasseByCollegeId(collegeId) {
	// GET /api/admin/academic/class-years/college/{collegeId}

	const requestOptions = { method: 'GET', headers: authHeader() };
	return fetch(`${AcademicAPI}/class-years/college/${collegeId}`, requestOptions)
	.then(handleResponse);
}