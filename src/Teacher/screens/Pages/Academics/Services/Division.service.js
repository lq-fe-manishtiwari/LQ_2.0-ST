...
export const DivisionService = {
    ...
    deleteDivision,
    getDivisionById,
    getDivisionByCollegeID,
    getDivisionBySemesterID
}; 
...
function getDivisionByCollegeID(collegeId) {
    // /: /api/admin/academic/divisions/college/{collegeId}
    const requestOptions = { method: 'GET', headers: authHeader() };
    return fetch(`${AcademicAPI}/divisions/college/${collegeId}`, requestOptions)
    .then(handleResponse);
}

function getDivisionBySemesterID(programClasssYearId,semesterId) {
    // /: api/admin/academic/program-class-year/8/semester/122/divisions
    const requestOptions = { method: 'GET', headers: authHeader() };
    return fetch(`${AcademicAPI}/program-class-year/${programClasssYearId}/semester/${semesterId}/divisions`, requestOptions)
    .then(handleResponse);
}