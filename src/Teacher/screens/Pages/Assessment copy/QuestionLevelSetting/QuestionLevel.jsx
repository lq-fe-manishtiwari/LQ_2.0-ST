  ...
  const handleDeleteClick = (level) => {
    setAlert(
      <SweetAlert
        ...
        onConfirm={() => handleConfirmDelete(level.question_level_id)}
    ...
    <>
      <div className="min-h-screen bg-[rgb(33,98,193)] bg-opacity-5 p-3 sm:p-4 md:p-6 lg:p-8">
        <div className="max-w-5xl mx-auto">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base
                                    ...
                                    focus:border-transparent transition-all ${errors.question_level_type && touched.question_level_type
                              ? 'border-red-500'
                              : 'border-gray-300'
                            }`}
          ...
          {/* Delete Confirmation & Result Alert */}
          {alert}
