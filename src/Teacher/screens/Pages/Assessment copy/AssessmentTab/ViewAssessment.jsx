        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
          ...
          <div className="flex items-center justify-between border-b border-gray-200 pb-6 mb-6">
            ...
            <div className="flex space-x-3">
              <button
                onClick={() => navigate('/admin-assessment/admin-add-new-assessment', { state: { assessmentData } })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div><span className="font-medium">Paper:</span> {assessmentData?.subject_name || '-'}</div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div><span className="font-medium">Total Marks:</span> {assessmentData?.total_marks ?? assessmentData?.questions?.reduce((sum, q) => sum + (q.marks_override || q.marks || 0), 0) ?? 0}</div>
