                          ...
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <input
                                ...
                                disabled={assessmentData?.category === 'OBJECTIVE' || assessmentData?.category_name === 'OBJECTIVE'}
                                className="w-20 px-2 py-1 border border-slate-300 rounded text-sm font-bold text-blue-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none disabled:opacity-50 disabled:cursor-not-allowed"
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        <div className={`p-4 rounded-xl border flex items-center gap-3 ${currentQuestion.isCorrect ? 'bg-green-50 border-green-200 text-green-800' : 'bg-red-50 border-red-200 text-red-800'
                          ...
                          <div>
                            ...
                            <span className="text-sm font-medium opacity-80">
                              {currentQuestion.isCorrect ? 'Correct Answer' : `Incorrect Answer ${currentQuestion.correctAnswer}`}
                            </span>
                          </div>
                        </div>
                      ) : (
