...
export default function AddPersonalTask() {
  ...
  const handleCancel = () => {
    navigate("/teacher/task-management/personal-tasks");
  };
    ...
    <div className="w-full flex flex-col gap-8 p-4 sm:p-6 md:p-8">
      ...
      {showSuccessAlert && (
        <SweetAlert success title="Success!" confirmBtnCssClass="btn-confirm"
          cancelBtnCssClass="btn-cancel" onConfirm={() => { setShowSuccessAlert(false); navigate("/teacher/task-management/personal-tasks"); }}
