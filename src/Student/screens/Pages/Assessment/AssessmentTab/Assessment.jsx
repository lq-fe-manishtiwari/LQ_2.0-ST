            ...
            >
              ...
              <div className="flex justify-center">
                {a.status === 'Not Attempted' ? (
                  <button 
                    onClick={() => navigate(`/my-assessment/assessment/start/${a.id}`)}
                    className="p-3 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-all duration-200 shadow-sm hover:shadow-md"
                    title="Start Assessment"
                  >
                  ...
                  <button 
                    onClick={() => navigate(`/my-assessment/assessment/take/${a.id}`)}
                    className="p-3 bg-orange-100 text-orange-600 rounded-lg hover:bg-orange-200 transition-all duration-200 shadow-sm hover:shadow-md"
                    title="Continue Assessment"
                  >
                  ...
                  <button 
                    onClick={() => navigate(`/my-assessment/assessment/result/${a.id}`)}
                    className="p-3 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 transition-all duration-200 shadow-sm hover:shadow-md"
                    title="View Result"
                  >
