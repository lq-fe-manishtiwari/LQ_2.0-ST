...
export default function MyCommittees() {
    ...
    // For students, use student_id which is stored as internal_user_id in committee members
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex gap-2 md:gap-4 overflow-x-auto">
                    <button
                        ...
                        className={`tab-link flex items-center justify-center gap-2 whitespace-nowrap px-3 py-2 flex-shrink-0 ${activeTab === 'committees' ? 'tab-active' : 'tab-inactive'}`}
                    ...
                    <button
                        ...
                        className={`tab-link flex items-center justify-center gap-2 whitespace-nowrap px-3 py-2 flex-shrink-0 ${activeTab === 'meetings' ? 'tab-active' : 'tab-inactive'}`}
                        style={{ minWidth: "140px" }}
                    >
                        ...
                        {committees.length === 0 ? (
                            ...
                            committees.map((committee) => (
                                <div
                                    ...
                                    onClick={() => navigate(`/student/committee/${committee.committee_id || committee.committeeId}`)}
                                >
                                            ...
                                            <tbody className="divide-y divide-gray-200">
                                                {paginatedMeetings.currentEntries.map((meeting) => (
                                                    <tr key={meeting.meeting_id || meeting.meetingId} className="hover:bg-gray-50 transition-colors">
                                                        ...
                                                        <td className="table-td text-center">
                                                            <button
                                                                onClick={() => navigate(`/student/committee/meeting/${meeting.meeting_id || meeting.meetingId}`)}
